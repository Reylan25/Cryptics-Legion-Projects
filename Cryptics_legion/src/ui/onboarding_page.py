...
def build_onboarding_content(page: ft.Page, on_get_started, state=None):
    """
    Builds and returns onboarding page content WITHOUT calling page.clean() or page.add().
    """
    theme = get_theme()
    ...
    return ft.Container(
        ...
        content=ft.Column([
            ft.Container(height=120),
            ft.Container(
                content=ft.Text("CL", size=80, weight=ft.FontWeight.BOLD, color="white"),
            ...
            ft.Container(
                content=ft.Text(
                    ...
                    size=15, color=theme.text_secondary if theme.mode == "light" else "#E1BEE7",
            ...
            ft.Container(
                content=ft.ElevatedButton(
                    "Get Started", width=340, height=55,
                    bgcolor=theme.accent_primary, color="white",
