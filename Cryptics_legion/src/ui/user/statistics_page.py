...
def build_statistics_content(page: ft.Page, state: dict, toast, 
            ...
            controls=[
                ft.Row(
                    controls=[
                        ft.Column(
                            controls=[
                                ft.Text("Your Statistics", size=24, weight=ft.FontWeight.BOLD, color=theme.text_primary),
                                ft.Text("Track and analyze your spending", size=12, color=theme.text_secondary),
                            ],
                            spacing=2,
                        ),
                        ...
                        ft.Row(
                            controls=[
                                ft.IconButton(
                                    ...
                                    on_click=lambda e: show_exchange_rates() if show_exchange_rates else None,
                                ),
    ...
    # Summary Card with trend and insights
            ...
            controls=[
                ft.Row(
                    controls=[
                        ft.Column(
                            controls=[
                                ft.Text("Total Spent", size=12, color=theme.text_secondary, weight=ft.FontWeight.W_500),
                                ft.Text(format_currency(stats['total_spent'], user_currency), size=32, weight=ft.FontWeight.BOLD, color=theme.text_primary),
                            ],
                            spacing=4,
                        ),
                        ft.Container(expand=True),
                        ft.Container(
                            content=ft.Column(
                                controls=[
                                    ft.Row(
                                        controls=[
                                            ft.Icon(trend_icon, color=trend_color, size=18),
                                            ft.Text(
                ...
                # Insight badges
                ft.Row(
                    controls=_create_insight_badges(stats, user_currency, theme),
                    spacing=8,
                ),
            ],
        ),
            ...
            controls=[
                ft.Row(
                    controls=[
                        ...
                        ft.Icon(ft.Icons.PIE_CHART, color=theme.accent_primary, size=20),
                    ],
                    spacing=8,
                ),
                ft.Text(
                ...
                ft.Container(height=12),
                ft.Text("Select Period:", size=12, color=theme.text_secondary, weight=ft.FontWeight.W_500),
                ft.Container(height=6),
                period_buttons,
                ft.Container(height=18),
                ft.Text("Category Distribution:", size=12, color=theme.text_secondary, weight=ft.FontWeight.W_500),
                ft.Container(height=6),
                pie_chart,
                ft.Container(height=20),
                ft.Divider(color=theme.border_primary, height=1),
                ...
                ft.Row(
                    controls=[
                        ft.Text("Daily Spending Pattern", size=16, weight=ft.FontWeight.W_600, color=theme.text_primary),
                        ft.Icon(ft.Icons.TRENDING_UP, color=theme.accent_primary, size=20),
                    ],
                    spacing=8,
                ),
                ft.Text(
                    "Track your daily expenses over the last 7 days",
                    size=11,
                    color=theme.text_secondary,
                    italic=True,
                ),
    ...
    # Category legend with better styling
            ...
            controls=[
                ft.Row(
                    controls=[
                        ...
                        ft.Icon(ft.Icons.CATEGORY, color=theme.accent_primary, size=20),
                    ],
                    spacing=8,
                ),
                ft.Text(
                ...
                ft.Column(
                    controls=[
                        *[_category_legend_item(cat["category"], cat["amount"], cat["percentage"], cat["color"], theme, user_currency) 
                        ...
                        ft.Column(
                            controls=[
                                ft.Icon(ft.Icons.INBOX, size=40, color=theme.text_muted),
                                ft.Text("No spending data yet", size=14, color=theme.text_muted, text_align=ft.TextAlign.CENTER),
                                ft.Text("Start adding expenses to see your categories here", size=11, color=theme.text_secondary, text_align=ft.TextAlign.CENTER),
                            ],
                            horizontal_alignment=ft.CrossAxisAlignment.CENTER,
                            spacing=12,
                        ),
    ...
    # Initialize the transactions list first
    transactions_section_content = ft.Column(spacing=8)
                ...
                ft.Row(
                    controls=[
                            ...
                            controls=[
                                ft.Row(
                                    controls=[
                                        ...
                                        ft.Icon(ft.Icons.HISTORY, color=theme.accent_primary, size=20),
                                    ],
                                    spacing=8,
                                ),
                                ft.Text(
                        ...
                        ft.TextButton(
                            content=ft.Row(
                                controls=[
                                    ft.Text("View All", color=theme.accent_primary, size=12),
                                    ft.Icon(ft.Icons.ARROW_FORWARD, color=theme.accent_primary, size=14),
                                ],
                                spacing=4,
                            ),
    ...
    for exp in all_expenses[:5]:
        eid, uid, amount, category, description, date_str, acc_id = exp[:7]
        acc_name, acc_currency = get_account_info(acc_id)
        transactions_section_content.controls.append(
            _transaction_item(
                category=category,
                description=description or category,
                amount=amount,
    ...
    if not all_expenses:
        transactions_section_content.controls.append(
            ft.Container(
                content=ft.Column(
                    controls=[
                        ft.Icon(ft.Icons.RECEIPT_LONG, color=theme.text_muted, size=40),
                        ft.Text("No transactions yet", color=theme.text_muted, size=14),
                        ft.Text("Start adding expenses to see them here", size=11, color=theme.text_secondary),
                    ],
                    horizontal_alignment=ft.CrossAxisAlignment.CENTER,
                    spacing=8,
                ),
...
def _create_helpful_tip(theme):
    """Create a helpful tip card to guide users on how to use statistics."""
    return ft.Container(
        content=ft.Column(
            controls=[
                ft.Row(
                    controls=[
                        ft.Icon(ft.Icons.LIGHTBULB, color="#F59E0B", size=20),
                        ft.Text("💡 Quick Tip", size=12, color="#F59E0B", weight=ft.FontWeight.W_600),
                        ft.Container(expand=True),
                        ft.IconButton(
                            icon=ft.Icons.CLOSE,
                            icon_size=16,
                ...
                ft.Text(
                    "Select a period to see your spending trends. Use the pie chart to understand where your money goes, and track daily spending patterns below.",
                    size=12,
                    color=theme.text_secondary,
                ),
            ],
        ...
        border_radius=12,
        bgcolor="#F59E0B15",
        border=ft.border.all(1, "#F59E0B30"),
    )


def _create_insight_badges(stats, user_currency, theme):
    """Create insight badges that show key metrics."""
    badges = []
    
    # Calculate savings percentage
    if stats.get("highest_expense") and stats.get("total_spent"):
        savings_insight = (stats["highest_expense"][1] / stats["total_spent"]) * 100
    else:
        savings_insight = 0
    ...
    for metric in metrics:
        badges.append(
            ft.Container(
                content=ft.Column(
                    controls=[
                        ft.Text(metric["icon"], size=18),
                        ft.Text(metric["title"], size=10, color=theme.text_secondary),
                        ft.Text(metric["value"], size=12, weight=ft.FontWeight.W_600, color=metric["color"]),
                    ],
                    horizontal_alignment=ft.CrossAxisAlignment.CENTER,
                    spacing=2,
                ),
