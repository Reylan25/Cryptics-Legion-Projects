...
def create_account_settings_view(page: ft.Page, state: dict, toast, go_back):
    ...
    def show_view():
        ...
        first_name_field = ft.TextField(
            ...
            on_blur=lambda e: auto_save_changes(),
        )
        ...
        currency_dropdown = ft.Dropdown(
            ...
            on_change=lambda e: auto_save_changes(),
        )
        ...
        # Re-define auto_save_changes here after photo_state is available
        def auto_save_changes():
            """Auto-save profile changes without showing a notification."""
            ...
            # Prepare form data with photo_state
            form_data = {
            ...
            # Save to database silently (no toast)
            try:
